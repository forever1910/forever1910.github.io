...
/***/ (function(module, exports, __webpack_require__) {
	...
	let oneObj = [
		{img:__webpack_require__(53),name:'One home'},
		{img:__webpack_require__(44),name:'A few homes <br> (1-9 homes)'},
		{img:__webpack_require__(52),name:'Many homes <br> (10+homes)'}
	]
	...
	function one(){
		$('.from > div').eq(0).addClass('active');
		let html = ""
		oneObj.map((item,index)=>{
			html += `<td><div class="box one_box ${index == 0 ? 'active':''}"><div class="icon"><img src="${item.img}"/></div><div class="text">${item.name}</div></div></td>`
		})
		$(".from .one_table tr").html(html);
		
		boxListen();
		
		$(".one .common_content_btn").click((e)=>{
			_state = 2;
			renderPage()
		})
	}
	...
	function two(){
		$('.from > div').eq(1).addClass('active');
		$('.point2 > div').addClass('active');
		
		let html = ""
		
		for (var i=0;i<_studio;i++){
			html += `<td><div class="box two_box ${i == 0 ? 'active':''}"><div class="num">${i + 1}</div></div></td>`
		}
		$(".from .two_table tr").html(html);
		
		boxListen();
		$(".two .common_content_btn").click((e)=>{
			_state = 3;
			renderPage()
		})
	}
	...
	function three(){
		$('.from > div').eq(2).addClass('active');
		$('.point3 > div').addClass('active');
		
		$(".three .common_content_btn").click((e)=>{
	...
	function boxListen(){
		$(".box").click((e)=>{
			...
			if($(e.target).hasClass("box")){
				...
				$(e.target).parents(".box").addClass("active");
			}
		})
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "img/efbf24f51235cd9c4344351e6ac386b1.png";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "img/0f036167978298a5a86ba949de60763e.png";

/***/ }),
/* 53 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/83d5e4b3ea74e1b0adfa372b3b8611e0.png";
