...
/******/ 	var hotCurrentHash = "69bdeaa86cf313d1bbbf"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//What benefits landlords get with Locals Obj
	let careArr = [
			{
				img:__webpack_require__(21)
				,title:'Profile & Listing'
				,content:'Stand-out listings created across all the best channels'
			},
			{
				img:__webpack_require__(22)
	...
	function buildCare(){
		...
		careArr.map((item,index)=>{
			html += `<a class="content_care_list_item" href="jacascript::void(0)" id="${index}"><div class="title" id="${index}">${item.title}</div><div class="content" id="${index}">${item.content}</div></a>`
		})
		$(".content_care_img").html(`<img src="${careArr[0].img}"/>`)
		$(".content_care_list").html(html);
		$(".content_care_list_item").click((e)=>{renderCareImg(e)})
		
	}
	
	function renderCareImg(e){
		$(".content_care_img").hide();
		$(".content_care_img").html(`<img src="${careArr[$(e.target).attr("id")].img}"/>`).fadeIn()
		
	}
	
	
	//What benefits landlords get with Locals
	function buildLandlordsImg(){
		let arr = [
			{img:__webpack_require__(49),name:'Yield maximization With our superior Pricing strategy'}
			,{img:__webpack_require__(50),name:'Total peace of mind Insurance and all maintenance managed'}
			,{img:__webpack_require__(51),name:'Maximised visibility of your listing, managed by us across 15+ channels'}
		]
		
		arr.map((item,index)=>{
			let html = `<td class="content_landlord_img_item"><img src="${item.img}"/><div class="content_landlord_img_item_name">${item.name}</div></td>`
			if(index < arr.length-1){
				html += `<td></td>`
			}
			$("body").find(".content_landlord_img tr").append(html)	
		})
	}
	
	
	//The landlord comments
	function buildCommentsMsg(){	
		$(".common_left_btn").click(()=>{renderCommentsMsg(1)})
		$(".common_right_btn").click(()=>{renderCommentsMsg(-1)})
		renderCommentsMsg()
	}
	
	function renderCommentsMsg(index){
		if(index > 0){
			commentsMsgIndex = (commentsMsgIndex + 1 > commentsMsgArr.length -1) ?  0 : commentsMsgIndex + 1;
		}else if(index < 0){
			commentsMsgIndex = (commentsMsgIndex - 1 < 0) ? commentsMsgArr.length -1 : commentsMsgIndex - 1;
		}
		$(".content_comment_tall_content div").html(commentsMsgArr[commentsMsgIndex].msg);
		$(".content_comment_tall_head").html(`<img src="${commentsMsgArr[commentsMsgIndex].img}"/>`);
		$(".content_comment_tall_title").html(commentsMsgArr[commentsMsgIndex].title);
		$(".content_comment_tall_text").html(commentsMsgArr[commentsMsgIndex].content);
		(index > 0 || index < 0) ? $(".content_comment_tall > div").fadeOut().fadeIn() : "";
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(1);
	! function() { 
		//<a alt="locals" href="'+parentUrl+'/view/contactUs.html"><li>Contact Us</li></a>
		var parentUrl = '';
		var i = '\t<a  alt="locals" href="'+parentUrl+'/index.html" title="locals 路客精品民宿"> <div  class="top-logo"  id="#logo" ></div> </a> <div class="top-nav" id="top-nav"> <ul>  <a alt="locals" class="nav_a" href="'+parentUrl+'/view/getStar.html"><li>Get Star</li><div class="line"></div></a><a class="nav_a" alt="locals" href="'+parentUrl+'/view/pricing.html"><li>Pricing</li><div class="line"></div></a> <a alt="locals" class="nav_a" href="'+parentUrl+'/view/whoWeAre.html"><li>Who we are</li><div class="line"></div></a>  <a  class="nav_a" alt="locals" href="'+parentUrl+'/view/whatWeDo.html"><li>What we do</li><div class="line"></div></a> <a class="nav_a" alt="locals" href="'+parentUrl+'/index.html"><li>Home</li><div class="line"></div></a></ul> </div>';
		var t = '\t<p>Montreal, Canada <span></span> +86 13789798792 <span></span> 13789798792@qq.com</p>';
		document.getElementById("nav").innerHTML = i;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function setClass(){
		setTimeout(function(){
			let activeObj = $('.swiperPaginationBox').find('.swiper-pagination-switch');
			activeObj.each((i)=>{
				activeObj.eq(i).addClass(`index_mini_bg${i+1}`)
			})
		},1)
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "img/d25f8ff62c8bcb2906afa9d58bb2cb40.png";

/***/ }),
/* 22 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/831cb1dec74a711155205d789cafdf7d.png";

/***/ }),
/* 23 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/bb4e4f9dd9d33c3c8b203fe05c75020d.png";

/***/ }),
/* 24 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/3dda32ac2d72bafb24a2ff0190864b11.png";

/***/ }),
/* 25 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/c0601d81d00b6db173530b63224e9d70.png";

/***/ }),
/* 26 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/6502e04a9b49c4e60e636e64f0c01fa1.png";

/***/ }),
/* 27 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/ac16362a5011445b2f6c4165cf9ba83d.png";

/***/ }),
/* 28 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/1dc39bf0e4414eddb59899aac13186e2.png";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "img/92019c0cfd06112026a04db55881acfe.png";

/***/ }),
/* 39 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/e91e774d322373f4180544c76e4bf2ae.png";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "img/8cfb9adfc72416f95310228805d2a704.png";

/***/ }),
/* 50 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/8a14b7c945ed8d4fd29355d1a74e063d.png";

/***/ }),
/* 51 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/2d2984a3877f88b5758b928bbd56d7c4.png";
